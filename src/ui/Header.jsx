...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 flex items-center bg-ash px-6 py-3 shadow-header dark:bg-black">
      <div
      ...
      <ul className="ml-auto flex items-center gap-4 ">
        {icons.map((icon) => {
          return (
            <li key={icon.name}>
              <a
                className="rounded-full bg-ash px-3 py-3 shadow-neum hover:shadow-deneum dark:bg-black dark:shadow-rounded-neum-dark dark:hover:bg-neum-bg-dark dark:hover:shadow-round-deneum-dark"
                href={icon.link}
              >
